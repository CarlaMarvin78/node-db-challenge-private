...
Relational databases store data and the relationships between that data; SQL is a langauge used to manipulate that data.

- [ ] Why do tables need a `primary key`?

Tables need a primary key to ensure that each row of the table is unique. 
...
We need an intermediary table called a Junction Table.
